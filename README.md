...
The final configuration is generated by `entrypoint.sh` from the template, environment variables, and `paths.yml` (if present).
...
Some parts of this project were written with help from AI tools, but this was not completely agentically generated or fully vibe-coded.
